                            ...
                            <div id="alert-{{ $item->id }}" class="bg-[#F2F2F2] w-full h-fit rounded-lg shadow-md p-4 flex role=" alert>
                                <div  class="basis-4/5">
                                    <div class="flex justify-between">
                                        ...
                                        <button type="button" class="ml-auto -mx-1.5 -my-5 -mr-40 bg-green-100 text-green-500 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-200 inline-flex h-8 w-8 dark:bg-green-200 dark:text-green-600 dark:hover:bg-green-300" data-dismiss-target="#alert-{{ $item->id }}" aria-label="Close">
