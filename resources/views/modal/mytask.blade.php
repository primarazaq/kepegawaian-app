...
<!-- Main modal -->
<div id="ModalMyTaskEMP-{{ $data->t_id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="ModalMyTaskEMP-{{ $data->t_id }}">
            ...
            <div class="p-6 space-y-2 text-base">
                <div class="pl-4">
                    ...
                    <form method="post" action="/employee/home/mytask/{{ $data->t_id }}"
                        ...
                        <div class="flex pr-32">
                            ...
                            <div class="mb-4 w-4/6">
                                <input
                                    ...
                                    aria-describedby="t_file_help" id="response_file-{{ $data->t_id }}"
                                    name="response_file" type="file">
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-300" id="t_file_help">*jpeg , jpg,
                                    png, docx, doc, pptx, ppt, xlsx, xls, pdf, zip, rar (MAX FILE 10MB).</p>
                            </div>
                        </div>
                        {{-- <div class="flex pr-32"> --}}
                        <div class="basis-1/5">
                        ...
                        <div class="mb-4 -mt-6">
                            <label for="response_body-{{ $data->t_id }}"
                                class="ml-4 text-lg font-semibold text-gray-900 dark:text-gray-300"></label>
                            <input id="response_body-{{ $data->t_id }}" class="inline-block w-5/6" type="hidden"
                                name="response_body" required>
                            @error('response_body')
                                <p>{{ $message }}</p>
                            @enderror
                            <trix-editor input="response_body-{{ $data->t_id }}" style="overflow-y:auto">
                            </trix-editor>
                        </div>
                        {{-- </div> --}}
            ...
            <!-- Modal footer -->
            <div
                class="flex items-center p-6 space-x-2 justify-center rounded-b border-t border-gray-200 dark:border-gray-600">
                <button type="submit"
