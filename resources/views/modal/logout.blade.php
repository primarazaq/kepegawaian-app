                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah anda yakin ingin menghapus data yang dipilih?</h3>
                  <div class="flex justify-center">
                    ...
                    <form action="" method="post">
                        @method('delete')
                        @csrf
                        <a href="{{ route('logout') }}" class="inline-flex border-0 text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-3xl text-sm items-center px-5 py-2.5 text-center mr-2">
                          Logout
                        </a>
                    </form>
                  </div>
