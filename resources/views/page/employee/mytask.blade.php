...
<div class="mx-auto w-11/12 border-2 shadow-md border-t-mainclr rounded-2xl">
    ...
    <div class="flex border-b-2 border-black">
        <div class="basis-4/5">
            ...
            <div class="flex mb-8 ">
<<<<<<< HEAD
                <p class=" ml-8 mt-1">Pengirim</p>
                <p class="inline-flex mt-1 mr-2">:</p>
                <p class="mt-1 mr-2">Ikhsan Nurul Rizki</p>
...
=======
                ...
                ?>
>>>>>>> 8738a30adee1217647cb8e6087f2dd197d516d00
            </div>
        </div>
        <div class="mx-auto items-center">
            <button type="button" class="text-white text-2xl bg-mainclr hover:bg-teal-700 font-medium rounded-full px-16 py-1 mr-2 mt-11" type="button" data-modal-toggle="ModalMyTaskEMP-{{ $data->t_id }}">Detail</button>
        </div> 
