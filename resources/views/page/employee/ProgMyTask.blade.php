                    ...
                    @foreach ($multiname as $name)
                        <div class="flex rounded-lg w-fit bg-teal-200 dark:bg-mainclr items-center text-center px-2 py-1">
                            ...
                            <div class="inline-flex ml-1">
                                <p class="text-base font-bold inline">{{ $name }}</p>
                            </div>
                        </div>
                    @endforeach
                </div>
            ...
            <div class="ml-7" id="old{{ $data->id }}">
                ...
                <div class="flex">
                    <svg version="1.1" id="Layer_1" class="w-5 h-5 fill-mainclr" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                     ...
                     <a href="{{ asset('storage/task-file/'.$data->response_file) }}" class="text-base font-medium text-mainclr dark:text-teal-500 hover:underline">
                        lihat file</a>
                    </div>
                     @endif
            </div>
                    ...
                    <trix-editor input="response_body-{{ $data->id }}"  style="height:10px !important;overflow-y:auto"></trix-editor>
                        @if ($data->response_file)
                                ...
                                <input type="hidden" name="old_file" value="{{ $data->response_file }}">
                                            <button id="ubah-{{ $data->id }}" type="button" class="ml-5 fill-mainclr flex items-center">
                                            ...
                                            <p class="text-base text-center inline-flex text-mainclr hover:underline ml-1">ubah file</p>
                                            </button>
                                </div>
                                ...
                                @else
                                <div id="ubahfile-{{ $data->id }}" class="flex pb-3">
                                    <input type="hidden" name="old_file" value="{{ $data->response_file }}">
                                                <button id="ubah-{{ $data->id }}" type="button" class="ml-5 fill-mainclr flex items-center">
                                                    <svg version="1.1" id="Capa_1" x="0px" y="0px"
                                                        width="15px" height="15px" viewBox="0 0 494.936 494.936" style="enable-background:new 0 0 494.936 494.936;"
                                                ...
                                                <p class="text-base text-center inline-flex text-mainclr hover:underline ml-1">Tambah file</p>
                                                </button>
                                    </div>
                                    <div id="filefield-{{ $data->id }}"></div>
                                    <script>
                                        ...
                                        btn.onclick = function(){
                                            grup.classList.add('hidden');
                                            element.innerHTML ='<input class="block w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 cursor-pointer dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="response_file_help" id="response_file_edit" name="response_file" type="file" value="{{ old('response_file', $data->response_file) }}"><p class="mt-1 mb-3 text-sm text-gray-500 dark:text-gray-300" id="response_file_help">*jpeg , jpg, png, docx, doc, pptx, ppt, xlsx, xls, pdf, zip, rar (MAX FILE 10MB).</p>';
                                            console.log(element.innerHTML);
                                        }
                                    </script>
                        ...
                        <div class="flex items-center justify-center mt-4">
                            <button id="cancel{{ $data->id }}" type="button" class="text-gray-900 bg-white border border-gray-300 hover:bg-gray-100 font-medium rounded-lg text-sm px-5 py-2 mr-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600">Cancel</button>
