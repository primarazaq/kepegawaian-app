...
<div class="flex items-center justify-end">
    ...
    <a href="/employee/home/taskcompleted" class="text-mainclr font-extrabold pt-4 ml-1 mr-4 hover:text-teal-600">
        Task Completed
    </a>
...
<div class="px-6 py-3 ">
    ...
    <div class="flex justify-between">
        <div class="border-b-2 w-full">
            ...
            <form method="post" action="/employee/home/taskcompleted/{{ $task->task_id }}">
                @method('put')
                @csrf
                <button type="submit" class="text-white bg-gradient-to-r from-yellow-400 via-orange-400 to-yellow-500 hover:bg-gradient-to-br font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Tandai belum selesai!</button>
            </form>
        </div>
