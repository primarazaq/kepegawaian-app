                ...
                <div class="flex">
                    ...
                    @if ($data->t_file)
                        <div id="ubahfile" class="flex">
                            <a href="{{ asset('storage/task-file/' . $data->t_file) }}" class="text-mainclr hover:text-teal-600 underline ml-5 -mt-1">lihat file sebelumnya</a>
    ...
    <div class=" bg-white p-5 rounded-r-lg">
        ...
        <div class="flex mb-4">
            ...
            <div class="font-extrabold text-lg ml-5">
                <input type="text" value="{{ $data->t_status }}" name="t_status" class="block bg-white border-white" readonly>
            </div>
        </div>
        <div class="flex mb-4">
