    ...
    public function boot()
    {
        ...
        if (Schema::hasTable('tasks') && Schema::hasTable('user_tasks')) {
            $notif = DB::table('tasks as b')
                ...
                ->where('b.deleted_at', null)->where('b.t_status', 'in progress')->orWhere('b.t_status', 'created')
            ...
            $notifPIC = DB::table('tasks as b')
                ...
                ->where('b.deleted_at', null)->where('b.t_status', 'completed')->orWhere('b.t_status', 'overdue')
                ->join('user_tasks as c', 'c.task_id', '=', 'b.id')
            ...
            $deadline = DB::table('tasks')->select('id', 't_due_date', 't_status')->where('deleted_at', null)->orderBy('t_due_date', 'asc')->get();
